//! Strand-aware set operations on [`StrandedRegionSet`].
//!
//! These operate on a `StrandedRegionSet` (regions paired with per-region
//! strands) and match strands when combining regions.
