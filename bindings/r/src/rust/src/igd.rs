...
#[extendr]
fn rextendr_igd_create(output_path: &str, filelist: &str, db_name: &str) -> std::result::Result<(), extendr_api::Error> {
...
#[extendr]
pub fn rextendr_igd_search(database_path: &str, query_path: &str) -> std::result::Result<Vec<String>, extendr_api::Error> {
